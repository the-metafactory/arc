...
|----------|-------|--------|
| 14 parallel research agents | npm attacks, MCP Registry, AAIF, Sigstore, plugin stores, capability models, prompt injection | [RESEARCH.md](https://github.com/mellanon/arc/blob/main/RESEARCH.md) |
...
| Security architecture design | Runtime enforcement, observability, integration | [SECURITY-ARCHITECTURE.md](https://github.com/mellanon/arc/blob/main/SECURITY-ARCHITECTURE.md) |
| Skill lifecycle design | End-to-end: author → package → install → enforce → upgrade → govern | [SKILL-LIFECYCLE.md](https://github.com/mellanon/arc/blob/main/SKILL-LIFECYCLE.md) |
...
|----------|-------|-------|
| [SECURITY-ARCHITECTURE.md](https://github.com/mellanon/arc/blob/main/SECURITY-ARCHITECTURE.md) | 4,158 | Runtime enforcement, observability, integration |
| [SKILL-LIFECYCLE.md](https://github.com/mellanon/arc/blob/main/SKILL-LIFECYCLE.md) | 3,800+ | End-to-end lifecycle, how all layers compose |
| [RESEARCH.md](https://github.com/mellanon/arc/blob/main/RESEARCH.md) | 5,390 | Landscape, council, red team |
| [DESIGN.md](https://github.com/mellanon/arc/blob/main/DESIGN.md) | 3,500+ | Transport, trust, governance (existing, reviewed previously) |
